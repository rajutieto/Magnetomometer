###########################################################################
## File : FFT_test_rtw.mk
## 
## Makefile generated for MATLAB file/project 'FFT_test'. 
## 
## Makefile Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\FFT_test.lib
...
PRODUCT_NAME              = FFT_test
MAKEFILE                  = FFT_test_rtw.mk
COMPUTER                  = PCWIN
ARCH                      = win32
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2013a
START_DIR                 = C:\Users\Raju\Desktop\Github\CO2_SE~1\code\Raju\MATLAB\codegen\lib\FFT_test
...
TOOLCHAIN_MAKEFILE = FFT_test_rtw_tools.mk

!include FFT_test_rtw_tools.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\FFT_test.lib
...
DEFINES_STANDARD = -DMODEL=FFT_test -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)\FFT_test_initialize.c $(START_DIR)\FFT_test_terminate.c $(START_DIR)\FFT_test.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c

###########################################################################
## OBJECTS
###########################################################################

OBJS = FFT_test_initialize.obj FFT_test_terminate.obj FFT_test.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
